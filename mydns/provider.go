...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			"mydns_a_record_set":     dataSourceDnsARecordSet(),
			"mydns_cname_record_set": dataSourceDnsCnameRecordSet(),
			"mydns_txt_record_set":   dataSourceDnsTxtRecordSet(),
		},

		ResourcesMap: map[string]*schema.Resource{
			"mydns_a_record_set":    resourceDnsARecordSet(),
			"mydns_aaaa_record_set": resourceDnsAAAARecordSet(),
			"dns_cname_record":      resourceDnsCnameRecord(),
			"mydns_ptr_record":      resourceDnsPtrRecord(),
		},
